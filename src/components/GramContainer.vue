<template>
  ...
  <div>
    <div v-if="step == 0">
      ...
      <gram-post :gramData="data" v-for="(data, i) in gramData" :key="i"> </gram-post>
    </div>
    ...
    <div v-if="step == 1">
      ...
      <div class="filters">
        ...
        <filter-box :uploadImage="uploadImage" v-for="(filter, i) in filters" :key="i" :class="filter" :filter="filter">
